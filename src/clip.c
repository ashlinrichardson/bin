/*20170927 mashup of [1] and [2] by a. richardson

Given points on two polygons, calculate area of intersection by:
calculating the area of the clip polygon

Refs
[1] https://rosettacode.org/wiki/Sutherland-Hodgman_polygon_clipping#C
[2] http://alienryderflex.com/polygon_area/
*/
