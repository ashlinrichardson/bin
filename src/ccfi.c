...
int main(int argc, char * argv[]){
  if(argc != 4){
    printf("ccfi.c: invert interpolated LHQ to solve for percentile height, which is used to evaluate interpolated CCF.\n");
    printf("By Ash Richardson, 20090616 with revisions 20170510.\nRequires GSL (GNU Scientific Library).\n");
