...
Application: some audio files have unexpected codecs. Ffmpeg knows how to sort it out!

Use this to fix audio files that appear broken and don't play. If so, they might have the wrong codec relative the file extension or something.'''
import os
import sys
